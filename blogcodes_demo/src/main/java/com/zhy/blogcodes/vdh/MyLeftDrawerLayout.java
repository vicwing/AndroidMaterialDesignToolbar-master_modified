...
/**
 * Created by cdj on 2015/10/22.
 */
public class MyLeftDrawerLayout extends ViewGroup {
    ...
    public MyLeftDrawerLayout(Context context, AttributeSet attrs) {
        super(context, attrs);
        LogUtils.d("MyLeftDrawerLayout.........");
        ...
        mHelper = ViewDragHelper.create(this, 1.0f,new ViewDragHelper.Callback() {
            ...
            public int clampViewPositionHorizontal(View child, int left, int dx) {
                ...
                LogUtils.d("clampViewPositionHorizontal...child=" +(-child.getWidth()) + "  left=" + left + " dx=" + dx+"  newleft="+newLeft);
                return newLeft;
            }

            @Override
            public boolean tryCaptureView(View child, int pointerId) {
                LogUtils.d("tryCaptureView....poniterId="+pointerId);
            ...
            public void onEdgeDragStarted(int edgeFlags, int pointerId) {
                LogUtils.d("onEdgeDragStarted.......pointerId="+pointerId);
            ...
            public void onViewReleased(View releasedChild, float xvel, float yvel) {
                ...
                LogUtils.d("releasedChild=" + releasedChild.getWidth() + " releasedChild.getLeft()=" + releasedChild.getLeft()+" offset="+offset);
                invalidate();
            }
            ...
            public void onViewPositionChanged(View changedView, int left, int top, int dx, int dy) {
                ...
                LogUtils.d("mLeftMenuOnScrren="+mLeftMenuOnScrren+"  childWidth="+childWidth+"   left="+left);
                invalidate();
            }

           @Override
           public int getViewHorizontalDragRange(View child){
                LogUtils.d("...child="+child+ ( mLeftMenuView == child ? 500: 0));
    ...
    protected void onLayout(boolean changed, int l, int t, int r, int b) {
        ...
        LogUtils.d("menuWidht=" + menuWidth + "  mLeftMenuOnScrren=" + mLeftMenuOnScrren + "  childLeft=" + childLeft);
    }
